...
const firebaseConfig = {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateWordCount(textarea) {
      ...
      const countDisplay = textarea.nextElementSibling?.nextElementSibling;
    ...
    function updateCountdown() {
      ...
      const deadline = new Date('2025-02-10T23:59:59').getTime();
      ...
      try {
        ...
        const formData = {
          ...
          research: {
            ...
            webTechnology: document.getElementById('webResearch').value.trim()
          },
          experience: {
            hasExperience:
